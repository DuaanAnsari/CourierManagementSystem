       ...
       <div class="sidebar pe-4 pb-3">
            <nav class="navbar navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="approval.php" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>Approvals</a>
...
<tbody>
    <?php  $connection= mysqli_connect("localhost" , "root" , "", "admin_approval");

  $select_user = "select id , username , email , Status from registration";
...
<tr> 
    ...
    <td><?php echo $data['Status']?> </td>
     <td> <form method="post">
             ...
             <button type="submit" name ="approve" value="Approved" class="button">Approve</button>
             <button type="submit" name= "reject" value="Rejected" class="button">Reject</button>
            </form>
            </td></tr>
<?php
            }
...
<?php
    if(isset($_POST['approve']))
    {
        ...
        echo "<script>alert('upadted');</script>";
    ...
    if(isset($_POST['reject']))
    {
        $id = $_POST['id'];
        $status = $_POST['reject'];
        $update = "delete from registration  where id=$id ";
        mysqli_query($connection,$update);
