       ...
       <div class="sidebar pe-4 pb-3">
            <nav class="navbar navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="agentmsg.php" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Agent Feedback</a>
...
<tbody>
    <?php  $connection= mysqli_connect("localhost" , "root" , "", "track");

  $select_user = "select id , name , email , msg from a_contact";
