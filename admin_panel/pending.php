                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="pending.php" class="dropdown-item active">Pending Deliveries</a>
       ...
       <nav class="navbar navbar-expand navbar-light sticky-top px-4 py-0">
        ...
        <tbody class="text-center">
            ...
            $sql = "select sender_detail.name , sender_detail.contact , c_detail.c_name , c_detail.c_city ,product.orderId, product.product, product.amount, product.vehicleNo, product.category , product.Status
             ...
             where c_detail.order_no=product.orderId and sender_detail.id=product.orderId and product.Status='Pending'";
            ...
            <td class="text-danger fw-bolder"> <a href="stat.php?id=<?php echo $data['orderId'];?>" class="text-reset"><?php  echo $data['Status']?></a></td>
