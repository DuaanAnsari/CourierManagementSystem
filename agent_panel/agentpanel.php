...
<link href="css/style.css" rel="stylesheet">
  ...
  <link rel="stylesheet" href="agentpanel.css">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar ">
                ...
                <div class="navbar-nav w-100">
                    <a href="agentpanel.php" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
...
<div class="col-10 mb-1">
    ...
    <div class="row justify-content-center">
        <div class="col-5 border height text-center" id="hover">
            <a href="newcourier.php" class="text-reset text-decoration-none"><img src="plus.png" id="plus" class="mx-auto">
           <p id="new">New Courier</p></a>
        </div>
        <div class="col-5 border height text-center" id="div2">
            <a href="updatecourier1.php" class="text-reset text-decoration-none"><img src="update.png" id="arrow" class="mx-auto">
            <p id="new">Update Courier</p></a>
        </div>
    </div>
</div>
<br><br><br><br>
