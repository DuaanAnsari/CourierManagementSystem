...
WHERE product.orderId = $id";
    ...
    <br>
    <div class="mb-3">
        <label class="text-center align-center justify-content-center"><h4>Showing results of <?php echo $PID;?></h4></label>
        <br>
    </div>
    <div class="row">
    <div class="mb-3 col">
    ...
    <div class="mb-3 col">
        ...
        <input type="text" class="form-control" name="bu_date" value="<?php echo $buy_date; ?>">
    </div>
    <div class="mb-3 col">
        <label class="form-label">Expected Delivery Date</label>
        <input type="text" class="form-control" name="de_date" value="<?php echo $delivery_date; ?>">
    </div>
    </div>
    <br>
